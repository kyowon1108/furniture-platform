  ...
  const tiles = useMemo(() => {
    ...
    // Regular rectangular room
      ...
      for (let y = 0; y < yCount; y++) {
        ...
        // Back wall (z=0) - normals point INWARD (toward room center, Z+)
        for (let x = 0; x < xCount; x++) {
          allTiles.push({
            key: `wall-back-${x}-${y}`,
            type: 'wall',
        ...
        // Front wall (z=depth) - normals point INWARD (toward room center, Z-)
        for (let x = 0; x < xCount; x++) {
          allTiles.push({
            key: `wall-front-${x}-${y}`,
            type: 'wall',
        ...
        // Left wall (x=0) - normals point INWARD (toward room center, X+)
        for (let z = 0; z < zCount; z++) {
          allTiles.push({
            key: `wall-left-${z}-${y}`,
            type: 'wall',
        ...
        // Right wall (x=width) - normals point INWARD (toward room center, X-)
        for (let z = 0; z < zCount; z++) {
          allTiles.push({
            key: `wall-right-${z}-${y}`,
            type: 'wall',
